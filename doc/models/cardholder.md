...
| `cardholderName` | `?string` | Optional | Name of the Cardholder.<br><br>This field is required unless market or regional mandate restricts sending this information.<br>**Constraints**: *Minimum Length*: `2`, *Maximum Length*: `45` | getCardholderName(): ?string | setCardholderName(?string cardholderName): void |
...
| `taxId` | `?string` | Optional | Tax ID is the Cardholder's tax identification.<br><br>This field is required depending on the rules provided by the Directory Server.<br>Available for supporting EMV 3DS 2.3.1 and later versions.<br>**Constraints**: *Maximum Length*: `45` | getTaxId(): ?string | setTaxId(?string taxId): void |
