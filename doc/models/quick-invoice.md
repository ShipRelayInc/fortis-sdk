...
| `files` | [`?(File2[])`](../../doc/models/file-2.md) | Optional | Files<br><br>> Maximum of 4 files & maximum size of 5MB per file.<br>> <br>**Constraints**: *Maximum Items*: `4` | getFiles(): ?array | setFiles(?array files): void |
