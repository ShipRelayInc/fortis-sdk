...
| `files` | [`?(File5[])`](../../doc/models/file-5.md) | Optional | Files<br><br>> Maximum of 4 files & maximum size of 5MB per file.<br>> <br>**Constraints**: *Maximum Items*: `4` | getFiles(): ?array | setFiles(?array files): void |
...
| `singlePaymentMaxAmount` | `?int` | Optional | Single Payment Max Amount | getSinglePaymentMaxAmount(): ?int | setSinglePaymentMaxAmount(?int singlePaymentMaxAmount): void |
