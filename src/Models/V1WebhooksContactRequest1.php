...
class V1WebhooksContactRequest1 implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the V1WebhooksContactRequest1 object to a human-readable string representation.
     *
     * @return string The string representation of the V1WebhooksContactRequest1 object.
     */
