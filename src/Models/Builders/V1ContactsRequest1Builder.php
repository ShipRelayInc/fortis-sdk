...
/**
 * Builder for model V1ContactsRequest1
 *
 * @see V1ContactsRequest1
 */
class V1ContactsRequest1Builder
{
    /**
     * @var V1ContactsRequest1
     */
    private $instance;

    private function __construct(V1ContactsRequest1 $instance)
    {
        $this->instance = $instance;
    }

    /**
     * Initializes a new V1 Contacts Request 1 Builder object.
     */
    public static function init(): self
    {
        return new self(new V1ContactsRequest1());
    }
    ...
    /**
     * Initializes a new V1 Contacts Request 1 object.
     */
    public function build(): V1ContactsRequest1
    {
