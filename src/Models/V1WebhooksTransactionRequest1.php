...
class V1WebhooksTransactionRequest1 implements \JsonSerializable
{
    ...
    /**
     * Converts the V1WebhooksTransactionRequest1 object to a human-readable string representation.
     *
     * @return string The string representation of the V1WebhooksTransactionRequest1 object.
     */
