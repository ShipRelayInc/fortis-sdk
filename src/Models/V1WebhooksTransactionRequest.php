...
class V1WebhooksTransactionRequest implements \JsonSerializable
{
    /**
     * @var array
     */
    ...
    /**
     * Converts the V1WebhooksTransactionRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1WebhooksTransactionRequest object.
     */
