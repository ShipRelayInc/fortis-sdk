...
class V1ContactsRequest implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $locationId, string $lastName)
    {
    ...
    /**
     * Converts the V1ContactsRequest object to a human-readable string representation.
     *
     * @return string The string representation of the V1ContactsRequest object.
     */
